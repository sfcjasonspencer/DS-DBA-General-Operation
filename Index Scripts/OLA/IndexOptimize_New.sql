...
/****** Object:  StoredProcedure [dbo].[IndexOptimize_New]    Script Date: 3/26/2020 11:26:38 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[IndexOptimize_New]
/*
 //////////////////////////////////////////////////////////////////////////////////////////////
    Purpose: To optimize the Indexes contained within the SQL Server databases.  The script is 
	the original script from Ola Hallengren.  The parameters have been set to meet the required 
	needs and the stored procedures and databases are located in the DBAMaintenance database.  
	More information can be found at https://ola.hallengren.com
    Object Type: Stored Procedure
    Date Added: 2019JUL19
    Version: 001
    Revision: A
    Author: Ola Hallengren (Modified by Jason Spencer for the Parameters only.)
    Title: DBA
    Scripting Tool: Visual Studio Code
    Custom: Yes
    Tags: BasicViewTemplate, Standards
    KeyParameters: None

    Additional Notes:
    Note 001: When adding a note ensure the note explains why the note was added. Be informative.
	Notes lines can also be used in the code comments to indicate See Note 002 at the top of script
    Note 002: Refer to this page https://ola.hallengren.com/sql-server-index-and-statistics-maintenance.html
	for information concerning the parameters that can be set.
        */
-- //////////////////////////////////////////////////////////////////////////////////////////////
-- Change Log Begins -->>
-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
/*  Change Date: 2019JUL19
    Version: 001
    Revision: A
    Author: Ola Hallengren (Modified by Jason Spencer for the Parameters only.)
    Title: DBA
...
--Modified on 3DEC2019 to test if this increases some performance.
@FragmentationMedium nvarchar(max) = 'INDEX_REBUILD_ONLINE,INDEX_REORGANIZE',

--Original Code Line
--@FragmentationHigh nvarchar(max) = 'INDEX_REBUILD_ONLINE,INDEX_REBUILD_OFFLINE',
@FragmentationHigh nvarchar(max) = 'INDEX_REBUILD_ONLINE,INDEX_REORGANIZE',

--Original Code Line
--@FragmentationLevel1 int = 5,
--@FragmentationLevel1 int = 20,
...
@DatabaseOrder nvarchar(max) = 'DATABASE_SIZE_ASC',

--Original Code Line
--@DatabasesInParallel nvarchar(max) = 'N',
@DatabasesInParallel nvarchar(max) = 'Y',
